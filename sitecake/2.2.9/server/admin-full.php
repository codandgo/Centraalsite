...
$app['SERVICE_URL'] = 'sitecake/2.2.9/server/admin.php';

// a URL relative to sitecake.php that Sitecake editor is using to load the login module
$app['EDITOR_LOGIN_URL'] = 'sitecake/2.2.9/client/publicmanager/publicmanager.nocache.js';

// a URL relative to sitecake.php that Sitecake editor is using to load the editor module
$app['EDITOR_EDIT_URL'] = 'sitecake/2.2.9/client/contentmanager/contentmanager.nocache.js';
